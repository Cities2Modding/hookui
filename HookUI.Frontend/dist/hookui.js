(() => {
  ...
  // src/jsx/_loader.jsx
  var loadExtensions = (extensions) => {
    extensions.forEach((extension) => {
      const script = document.createElement("script");
      script.src = "Extensions/" + extension;
      script.async = true;
      script.className = "hookui_extension";
  ...
  var $Loader = ({ react }) => {
    ...
    react.useEffect(() => {
      const handleEvent = (e) => {
        ...
        if (visibleComponents.includes(id)) {
          ...
          setVisibleComponents((visibleComponents2) => [...visibleComponents2, id]);
        }
      };
    ...
    const panels = Object.keys(window._$hookui.__registeredPanels).filter((i) => visibleComponents.includes(i)).map((k) => window._$hookui.__registeredPanels[k]);
  ...
  var $MenuItem = ({ icon }) => {
    return /* @__PURE__ */ import_react7.default.createElement("button", { className: "button_FBo button_ECf item_It6 item-mouse-states_Fmi item-selected_tAM item-focused_FuT toggle-states_DTm button_FBo button_ECf item_It6 item-mouse-states_Fmi item-selected_tAM item-focused_FuT toggle-states_DTm item_IYJ" }, /* @__PURE__ */ import_react7.default.createElement("img", { className: "icon_ZjN icon_soN icon_Iwk", src: icon }));
  };
  var $MenuRow = ({ children, onClick }) => {
    return /* @__PURE__ */ import_react7.default.createElement("div", { className: "row_B8G", onClick }, children);
  };
  var toggleVisibility = (id) => {
    return () => {
      const data = { type: "toggle_visibility", id };
  ...
  var getPanels = () => {
    ...
    const $panels = ks.map((k) => {
      ...
      return /* @__PURE__ */ import_react7.default.createElement($MenuRow, { onClick: toggleVisibility(panel.id) }, /* @__PURE__ */ import_react7.default.createElement($MenuItem, { icon: panel.icon }), panel.name);
    });
    return $panels;
  };
  var $Menu = ({ visible }) => {
    ...
    if ($panels.length === 0) {
      $panels.push(/* @__PURE__ */ import_react7.default.createElement($MenuRow, null, "No ModUIs added!"));
    }
    const style = {
      bottom: "initial",
      opacity: visible ? 1 : 0,
      ...
      transitionDelay: visible ? "0s" : "0.05s"
      // Delay applying 'hidden' when fading out
    };
    return /* @__PURE__ */ import_react7.default.createElement("div", { class: "info-layout_BVk", style }, /* @__PURE__ */ import_react7.default.createElement("div", { class: "infoview-menu_LhU infoview-menu_VQI" }, /* @__PURE__ */ import_react7.default.createElement("div", { class: "panel_YqS menu_O_M" }, /* @__PURE__ */ import_react7.default.createElement("div", { class: "content_XD5 content_AD7 child-opacity-transition_nkS content_Hzl" }, ...$panels))));
  };
  var $HookUIMenu = ({ react }) => {
    const [showMenu, setShowMenu] = react.useState(false);
    use_data_update_default(react, "hookui.is_menu_open", (new_val) => {
      setShowMenu(new_val);
    });
    const toggleMenu = () => {
    ...
    return /* @__PURE__ */ import_react7.default.createElement("button", { className: "button_ke4 button_ke4 button_H9N", style: { marginLeft: "5rem" }, onClick: toggleMenu }, /* @__PURE__ */ import_react7.default.createElement("div", { className: "tinted-icon_iKo icon_be5", style: { maskImage: "url(Media/Glyphs/Student.svg)" } }), /* @__PURE__ */ import_react7.default.createElement($Menu, { visible: showMenu }));
  };
